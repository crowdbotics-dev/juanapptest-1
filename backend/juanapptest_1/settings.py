"""
Django settings for juanapptest_1 project.
...
ROOT_URLCONF = 'juanapptest_1.urls'
...
WSGI_APPLICATION = 'juanapptest_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanapptest_1 API",
    "DESCRIPTION": "API documentation for juanapptest_1 App",
    "VERSION": "v1",
}
